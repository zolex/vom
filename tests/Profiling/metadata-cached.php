...
$serializer = VersatileObjectMapperFactory::create(new ArrayAdapter());
...
// Warm up the PSR-6 cache with an initial call before profiling
...
// fetched from the PSR-6 cache (ArrayAdapter), never from reflection
for ($i = 0; $i < 1000; ++$i) {
